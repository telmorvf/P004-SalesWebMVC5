...
namespace SalesWebMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            // falta testar se DB não existe, então deve criar
            
            Department d1 = new Department(1, "Computers");
            Department d2 = new Department(2, "Electronics"); // Ou, sem usar o construtor
            ...
            Seller s6 = new Seller(6, "Alex Pink", "alex@yopmail.com", new DateTime(1997, 3, 4), 3000.0, d2);
